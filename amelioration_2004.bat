...
@powershell -NoProfile -ExecutionPolicy Bypass -Command "choco install -y --force --allow-empty-checksums brave open-shell -installArgs ADDLOCAL=StartMenu vlc 7zip jpegview vcredist-all directx wget"
